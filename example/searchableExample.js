...
const options = [
  ...
  { type: 'group', name: 'America', items : [
    ...
    { value: 'America/Porto_Velho', label: 'Porto_Velho' },
  ...
  { type: 'group', name: 'Antarctica', items : [
  ...
  { type: 'group', name: 'Arctic', items : [
    { value: 'Arctic/Longyearbyen', label: 'Longyearbyen' },
  ] },
  { type: 'group', name: 'Argentina', items : [
    { value: 'Argentina/Buenos_Aires', label: 'Buenos_Aires' },
    { value: 'Argentina/Catamarca', label: 'Catamarca' },
    { value: 'Argentina/Cordoba', label: 'Cordoba' },
    { value: 'Argentina/Jujuy', label: 'Jujuy' },
    { value: 'Argentina/La_Rioja', label: 'La_Rioja' },
    { value: 'Argentina/Mendoza', label: 'Mendoza' },
    { value: 'Argentina/Rio_Gallegos', label: 'Rio_Gallegos' },
    { value: 'Argentina/Salta', label: 'Salta' },
    { value: 'Argentina/San_Juan', label: 'San_Juan' },
    { value: 'Argentina/San_Luis', label: 'San_Luis' },
    { value: 'Argentina/Tucuman', label: 'Tucuman' },
    { value: 'Argentina/Ushuaia', label: 'Ushuaia' },
  ] },
  { type: 'group', name: 'Asia', items : [
    ...
    { value: 'Asia/Ho_Chi_Minh', label: 'Ho_Chi_Minh' },
  ...
  { type: 'group', name: 'Atlantic', items : [
  ...
  { type: 'group', name: 'Indiana', items : [
    { value: 'Indiana/Indianapolis', label: 'Indianapolis' },
    { value: 'Indiana/Knox', label: 'Knox' },
    { value: 'Indiana/Marengo', label: 'Marengo' },
    { value: 'Indiana/Petersburg', label: 'Petersburg' },
    { value: 'Indiana/Tell_City', label: 'Tell_City' },
    { value: 'Indiana/Vevay', label: 'Vevay' },
    { value: 'Indiana/Vincennes', label: 'Vincennes' },
    { value: 'Indiana/Winamac', label: 'Winamac' },
  ] },
  { type: 'group', name: 'Kentucky', items : [
    { value: 'Kentucky/Louisville', label: 'Louisville' },
    { value: 'Kentucky/Monticello', label: 'Monticello' },
  ] },
  { type: 'group', name: 'North_Dakota', items : [
    { value: 'North_Dakota/Beulah', label: 'Beulah' },
    { value: 'North_Dakota/Center', label: 'Center' },
    { value: 'North_Dakota/New_Salem', label: 'New_Salem' },
  ] },
  { type: 'group', name: 'Pacific', items : [
...
class SearchableExample extends Component {
  constructor (props) {
    super(props)
    const selected = Intl
